    ...
    return (
        <>
            ...
            <p className="m-5 text-center text-xl">
                ...
                imaginación cobra vida en forma de juegos únicos y cautivadores.
            </p>
            <p className="m-5 text-center text-xl">
                Los jueces expertos evalúan cada obra maestra en categorías como
                Jugabilidad, Arte, Sonido y Afinidad a la Temática. ¡Prepárate
                para sumergirte en una experiencia donde la pasión por el
